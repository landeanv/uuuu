...
# status
rm -rf /root/status
wget -q -O /root/status "https://raw.githubusercontent.com/landeanv/v5/master/statushariini"
...
#######PERIZINAN
BURIQ () {
    curl -sS https://raw.githubusercontent.com/landeanv/v5/master/gerung > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/messiey/landeanv/v5/gerung | grep $MYIP | awk '{print $2}')
